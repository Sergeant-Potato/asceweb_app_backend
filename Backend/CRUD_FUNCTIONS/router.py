import traceback
from fastapi import Depends, FastAPI, HTTPException, Response, Request, APIRouter
...
"""To view documentation of the endpoints change the below variable to be 
    user = FastAPI()
"""
# user = FastAPI(docs_url=None, redoc_urcl=None)
user = APIRouter()
...
@user.post("/ascepupr/login/user/form/user/logintodashboard/", response_model=Administrators_Schemas.Administrator_Validate_User)
...
@user.post("/ascepupr/dashboard/user/create/admin/createadmin/",status_code=HTTP_201_CREATED, response_model=Administrators_Schemas.Output_return)
...
@user.post("/ascepupr/competitions/form/signuptocompetition/", status_code=HTTP_201_CREATED, response_model=Administrators_Schemas.Output_return)
...
@user.post("/ascewepupr/signup/form/signuptochapter/", status_code=HTTP_201_CREATED,response_model=Administrators_Schemas.Output_return)
...
@user.get("/ascepupr/dashboard/user/table/admins/", status_code=HTTP_200_OK,response_model=Administrators_Schemas.Output_return)
...
@user.get("/ascepupr/dashboard/user/table/members/",status_code=HTTP_200_OK, response_model=Administrators_Schemas.Output_return)
...
@user.get("/ascepupr/dashboard/user/table/competitions/", status_code=HTTP_200_OK,response_model=Administrators_Schemas.Output_return)
...
@user.get("/ascewepupr/isTokenValid/", status_code=HTTP_200_OK, response_model=Administrators_Schemas.Output_return)
...
@user.put("/ascepupr/dashboard/admin/table/update/admin/updatefromadmin/", status_code=HTTP_201_CREATED,response_model=Administrators_Schemas.Output_return)
...
@user.put("/ascepupr/dashboard/admin/table/update/members/updatefrommember", status_code=HTTP_201_CREATED,response_model=Administrators_Schemas.Output_return)
...
@user.put("/ascepupr/dashboard/admin/table/update/competitionsmember/updatefromcompetitionsmember", status_code=HTTP_201_CREATED,response_model=Administrators_Schemas.Output_return)
...
@user.delete("/ascepupr/dashboard/admin/table/delete/admin/deleteadminfromtable/", status_code=HTTP_200_OK,response_model=Administrators_Schemas.Output_return)
...
# @user.delete("/ascepupr/dashboard/admin/table/delete/members/deletemembers/", status_code=HTTP_200_OK,response_model=Administrators_Schemas.Output_return)
...
@user.delete("/ascepupr/dashboard/admin/table/delete/competitionsmember/deletecompetitionsmember/", status_code=HTTP_200_OK,response_model=Administrators_Schemas.Output_return)
...
@user.delete("/ascepupr/dashboard/admin/table/delete/members/list/deletemembers/", response_model=Administrators_Schemas.Output_return)
...
@user.delete("/ascepupr/dashboard/admin/table/delete/members/list/deletecompetitions/", response_model=Administrators_Schemas.Output_return)
